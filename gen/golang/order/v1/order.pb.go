...
const (
	Status_STATUS_PENDING_UNSPECIFIED Status = 0
...
func (x *Order) GetStatus() Status {
	...
	return Status_STATUS_PENDING_UNSPECIFIED
}
...
var file_order_v1_order_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0xd3, 0x01, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12,
	0x19, 0x0a, 0x08, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x73, 0x12, 0x28, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x10, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x74, 0x61,
	...
	0x52, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x2a, 0x53, 0x0a, 0x06, 0x53,
	...
	,
	...
	0x17, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72,
	...
	0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2f, 0x76, 0x31,
	0x3b, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x76, 0x31, 0xa2, 0x02, 0x03, 0x4f, 0x58, 0x58, 0xaa, 0x02,
...
var file_order_v1_order_proto_goTypes = []any{
	...
	(*CreateRequest)(nil),  // 1: order.v1.CreateRequest
	(*CreateResponse)(nil), // 2: order.v1.CreateResponse
	(*GetRequest)(nil),     // 3: order.v1.GetRequest
	(*GetResponse)(nil),    // 4: order.v1.GetResponse
	(*UpdateRequest)(nil),  // 5: order.v1.UpdateRequest
	(*UpdateResponse)(nil), // 6: order.v1.UpdateResponse
	(*DeleteRequest)(nil),  // 7: order.v1.DeleteRequest
	(*DeleteResponse)(nil), // 8: order.v1.DeleteResponse
	(*Item)(nil),           // 9: order.v1.Item
	(*Order)(nil),          // 10: order.v1.Order
}
var file_order_v1_order_proto_depIdxs = []int32{
	9,  // 0: order.v1.CreateRequest.items:type_name -> order.v1.Item
	10, // 1: order.v1.CreateResponse.order:type_name -> order.v1.Order
	10, // 2: order.v1.GetResponse.order:type_name -> order.v1.Order
	9,  // 3: order.v1.UpdateRequest.items:type_name -> order.v1.Item
	10, // 4: order.v1.UpdateResponse.order:type_name -> order.v1.Order
	9,  // 5: order.v1.Order.items:type_name -> order.v1.Item
	0,  // 6: order.v1.Order.status:type_name -> order.v1.Status
	1,  // 7: order.v1.OrderService.Create:input_type -> order.v1.CreateRequest
	3,  // 8: order.v1.OrderService.Get:input_type -> order.v1.GetRequest
	5,  // 9: order.v1.OrderService.Update:input_type -> order.v1.UpdateRequest
	7,  // 10: order.v1.OrderService.Delete:input_type -> order.v1.DeleteRequest
	2,  // 11: order.v1.OrderService.Create:output_type -> order.v1.CreateResponse
	4,  // 12: order.v1.OrderService.Get:output_type -> order.v1.GetResponse
	6,  // 13: order.v1.OrderService.Update:output_type -> order.v1.UpdateResponse
	8,  // 14: order.v1.OrderService.Delete:output_type -> order.v1.DeleteResponse
